        ...
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="mb-8">
                <h2 class="text-2xl font-black text-gray-900 uppercase tracking-tight italic">
                    Nuevo Partido <span class="text-blue-600">// {{ $equipo->nombre }}</span>
                </h2>
            </div>
            ...
            <div class="bg-white border border-gray-200 shadow-sm overflow-hidden relative group">
                ...
                <div class="p-8">
                    <form method="POST" action="{{ route('partidos.guardar', $equipo) }}" class="space-y-6">
                        @csrf
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                @error('fecha')<p class="mt-2 text-xs text-red-500">{{ $message }}</p>@enderror
                            </div>
                            <div>
                        ...
                        <div>
                            ...
                            <input type="text" name="rival" value="{{ old('rival') }}" required
                                class="block w-full bg-white border border-gray-300 text-gray-900 px-4 py-3 text-sm focus:border-blue-500 focus:ring-0 shadow-sm hover:border-blue-400 transition-colors @error('rival') border-red-400 @enderror">
                            @error('rival')<p class="mt-2 text-xs text-red-500">{{ $message }}</p>@enderror
                        </div>
